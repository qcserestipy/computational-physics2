...
real, dimension(3,3), intent(in) :: A(3,3)
real, dimension(3,3), intent(out) :: L(3,3)
real, dimension(3,3), intent(out) :: U(3,3)
real :: summ = 0.0d0
...
real, intent(in), dimension(3,3) :: l_mat(3,3)
real, intent(out),dimension(3) :: y_vec(3)
real, intent(in),dimension(3) :: b_vec(3)
real :: summ = 0.0d0
